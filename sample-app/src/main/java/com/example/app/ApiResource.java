...
public class ApiResource {
    ...
    public Response db() {
        ...
        out.put("peer", Env.get("PEER_NAME_AURORA", "DataBase（Aurora_MySQL）"));
    ...
    public Response cache() {
        Map<String, Object> out = new LinkedHashMap<>();
        out.put("peer", Env.get("PEER_NAME_VALKEY", "session_store（Valkey）"));
    ...
    public Response report() {
        ...
        return proxy(Env.get("PEER_NAME_EC2", "ec2_server"), url, "container-to-report");
    }
